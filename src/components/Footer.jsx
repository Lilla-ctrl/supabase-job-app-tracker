    ...
    <footer className=" w-full bg-primary transition-colors duration-500 pt-10">
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 text-sm tracking-tight text-text px-6 py-8">
        ...
        <div className="text-text/60">
          <span className="font-semibold text-text/80">© 2026 Lilla </span>
          <span className="hidden sm:inline text-text/40"> — </span>
          <span className="block sm:inline">Front-end Developer</span>
        </div>
        {/* Right side: Github */}
        <a
          href="https://github.com/Lilla-ctrl/supabase-job-app-tracker.git"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 text-text/60 hover:text-button transition-colors duration-300 group"
        >
          <GithubIcon className="w-4 h-4" />
          <span className="font-link group-hover:underline decoration-button/30 underline-offset-4">
            View Source
          </span>
        </a>
      </div>
